...
export const SubjectCard = () => {
    return (
        <>
            <div className="flex items-center justify-between gap-4 bg-white  rounded-md shadow-md p-4 max-w-lg mx-auto mt-6 cursor-pointer">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-[#293080] text-sm sm:text-base">
                        Top 10 Students List &nbsp; <span className="font-medium text-black">CS Semester 1st</span>
                      </h3>
