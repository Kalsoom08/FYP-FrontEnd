import timetable_sketch from '../../assets/Timetable/timetable.png';
import { IoMdDownload } from "react-icons/io";

export const TimetableCard = () => {
  return (
    <div className="flex flex-col items-center gap-4 border-2 border-[#293080] rounded-md px-4 py-6 w-full max-w-xs sm:max-w-sm bg-white">
      ...
      <div className="w-[150px] h-[150px] sm:w-[180px] sm:h-[180px] flex justify-center items-center bg-gray-100 rounded-md">
        <img src={timetable_sketch} alt="Timetable Sketch" className="w-[90px] sm:w-[100px]" />
      </div>
      ...
      <p className="text-[11px] text-gray-500 text-center">
        Last updated: June 2025 <br /> Updated by Admin
      </p>
    </div>
  );
};
